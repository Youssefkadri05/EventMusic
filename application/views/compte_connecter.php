    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div  class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          ...
          <?php header("refresh:0;url=".base_url()."index.php/Compte/connecter#MaPageDeConnexion"); } ?>
			    <?php echo form_open('compte/connecter'); ?>
            <h3 id="MaPageDeConnexion" class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in</h3>
